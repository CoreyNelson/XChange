...
public class LivecoinAdapters {
    ...
    public static ExchangeMetaData adaptToExchangeMetaData(
        ...
        for (LivecoinRestriction product : products) {
            // HACK ALERT! Livecoin trades a currency called "XBT" that is not Bitcoin! Since the Currency class treats
            // BTC and XBT as equal, this causes bugs when comparing the two currencies. Particularly troublesome is
            // the XBT/BTC pair. The easiest workaround for these problems is to just remove pairs that contain XBT.
            // I've done a bit of googling and I can't even figure out what shit coin it is. We don't need it.
            if (product.getCurrencyPair().contains("XBT")) continue;
